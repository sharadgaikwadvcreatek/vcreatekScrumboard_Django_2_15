...
(function (window, document, $) {
  ...
  $('#progress').select2({
    placeholder: 'Select a progress of task'
  });

  $('#level_2').select2({
    placeholder: 'Select a level 2'
  });
  ...
  $('#priority_f_v').select2({
    placeholder: 'Search priority'
  });

  $('#project_status_f').select2({
  ...
  $('#task_status_f').select2({
    placeholder: 'Search progress'
  });

  $('#level_2_f').select2({
    placeholder: 'Search 1evel 2'
  });
